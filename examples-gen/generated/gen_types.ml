...
let param_core____time_float__zone__t =
  Defunc.Of_python.create
    ~type_name:"Core__.Time_float.Zone.t"
    ~conv:core____time_float__zone__t_of_python
;;

let ( python_of_base__ppx_hash_lib__std__hash__hash_value
    , base__ppx_hash_lib__std__hash__hash_value_of_python )
  =
...
let param_base__ppx_hash_lib__std__hash__hash_value =
  Defunc.Of_python.create
    ~type_name:"Base__Ppx_hash_lib.Std.Hash.hash_value"
    ~conv:base__ppx_hash_lib__std__hash__hash_value_of_python
;;
...
let param_core____time_float__t =
  Defunc.Of_python.create
    ~type_name:"Core__.Time_float.t"
    ~conv:core____time_float__t_of_python
;;
...
let param_core____day_of_week__t =
  Defunc.Of_python.create
    ~type_name:"Core__.Day_of_week.t"
    ~conv:core____day_of_week__t_of_python
;;
...
let param_bin_prot____shape__t =
  Defunc.Of_python.create
    ~type_name:"Bin_prot__.Shape.t"
    ~conv:bin_prot____shape__t_of_python
;;
...
let param_core__date__option__t =
  Defunc.Of_python.create
    ~type_name:"Core__Date.Option.t"
    ~conv:core__date__option__t_of_python
;;
...
let param_core__date__days__t =
  Defunc.Of_python.create
    ~type_name:"Core__Date.Days.t"
    ~conv:core__date__days__t_of_python
;;
...
let param_base____formatter__t =
  Defunc.Of_python.create
    ~type_name:"Base__.Formatter.t"
    ~conv:base____formatter__t_of_python
;;
...
let param_sexplib0____sexp__t =
  Defunc.Of_python.create
    ~type_name:"Sexplib0__.Sexp.t"
    ~conv:sexplib0____sexp__t_of_python
;;
